<template>
  <div class="blog-sidebar sidebar-content-wrap">
    ...
    <div class="sidebar-item">
      <h5 class="sb-title font-3 text-linear">Case studies</h5>
      <div class="br-line has-dot"></div>
      <ul class="sb-case">
        <li class="sb-case_item">
          <a href="#">
            <div class="d-flex align-items-center">
              <i class="icon icon-FileText"></i>
            </div>
            <div>
              <div class="br-line has-dot type-hor"></div>
            </div>
            <p class="text-main-2 text">
    ...
    <div class="sidebar-item">
      <h5 class="sb-title font-3 text-linear">Latest updates</h5>
      <div class="br-line has-dot"></div>
      <ul class="sb-recent">
    ...
    <div class="sidebar-item">
      <h5 class="sb-title font-3 text-linear">Download</h5>
      <div class="br-line has-dot"></div>
      <ul class="sb-download">
        <li>
          <a href="#" class="tf-btn style-4 link text-body-3">
            <i class="icon icon-FileText"></i>
            Report for 2025 <span class="text-main-7">1.7 KB</span>
          </a>
        </li>
        <li>
          <a href="#" class="tf-btn style-4 link text-body-3">
            <i class="icon icon-FileText"></i>
            Our brochure<span class="text-main-7">1.7 KB</span>
          </a>
        </li>
      </ul>
    </div>
