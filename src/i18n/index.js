...
const languagePacks = {
  'zh-cn': {
    ...
    'crash.fairness.calcTitle': '验证计算器',
    ...
    'crash.fairness.thirdPartyTitle': '第三方工具验证',
    ...
    'crash.fairness.step4Tool': '打开 Hex to Decimal Converter',
  ...
  'zh-tw': {
    ...
    'crash.fairness.dataCompositionDesc': '用於驗證的輸入數據是由以下三個部分依次拼接而成的：',
    'crash.fairness.copyInput': '第一步：複製輸入數據 (Hex)',
    ...
    'crash.fairness.openTool': '第二步：打開工具',
    'crash.fairness.toolLinkText': '在線 Keccak256 計算器',
    'crash.fairness.verifyInst': '第三步：粘貼數據，選擇 "Hex" 輸入類型，比對結果。',
  ...
  'en': {
    ...
    'crash.fairness.calcTitle': 'Verification Calculator',
    ...
    'crash.fairness.thirdPartyTitle': 'Third-party Verification',
    ...
    'crash.fairness.step4Tool': 'Open Hex to Decimal Converter',
  ...
  'ja': {
    ...
    'crash.fairness.dataCompositionDesc': '検証用の入力データは、以下の3つの部分を順番に連結して構成されています：',
    ...
    'crash.fairness.openTool': 'ステップ2：ツールを開く',
    'crash.fairness.toolLinkText': 'オンライン Keccak256 計算機',
    'crash.fairness.verifyInst': 'ステップ3：データを貼り付け、「Hex」入力タイプを選択して比較します。',
    'sidebar.crashGame': 'Blast',
  ...
  'ko': {
    ...
    'crash.fairness.dataCompositionDesc': '검증용 입력 데이터는 다음 세 부분을 순서대로 연결하여 구성됩니다:',
    ...
    'crash.fairness.openTool': '2단계: 도구 열기',
    'crash.fairness.toolLinkText': '온라인 Keccak256 계산기',
    'crash.fairness.verifyInst': '3단계: 데이터를 붙여넣고 "Hex" 입력 유형을 선택하여 비교합니다.',
    'sidebar.crashGame': 'Blast',
