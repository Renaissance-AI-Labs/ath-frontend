...
const languagePacks = {
  'zh-cn': {
    ...
    'crash.rules': '规则说明',
    'crash.fairness': '公平验证',
    'crash.rulesContent': '在这里您可以详细了解游戏规则。例如：\n1. 设置您的投注金额。\n2. 观察倍数增长。\n3. 在倍数爆炸前随时点击结算。\n4. 祝您好运！',
  ...
  'zh-tw': {
    ...
    'crash.rules': '規則說明',
    'crash.fairness': '公平驗證',
    'crash.rulesContent': '在這裡您可以詳細了解遊戲規則。例如：\n1. 設置您的投注金額。\n2. 觀察倍數增長。\n3. 在倍數爆炸前隨時點擊結算。\n4. 祝您好運！',
  ...
  'en': {
    ...
    'crash.rulesContent': 'Here you can learn about the game rules in detail. For example:\n1. Set your bet amount.\n2. Watch the multiplier grow.\n3. Cash out anytime before it crashes.\n4. Good luck!',
  ...
  'ja': {
    ...
    'crash.rulesContent': 'ここでゲームのルールを詳しく確認できます。例：\n1. ベット額を設定します。\n2. 倍率が上昇するのを見守ります。\n3. クラッシュする前にいつでもキャッシュアウトをクリックします。\n4. 幸運を祈ります！',
  ...
  'ko': {
    ...
    'crash.rulesContent': '여기에서 게임 규칙을 자세히 알아볼 수 있습니다. 예:\n1. 베팅 금액을 설정합니다.\n2. 배율이 증가하는 것을 지켜봅니다.\n3. 폭발하기 전에 언제든지 정산을 클릭합니다.\n4. 행운을 빕니다!',
