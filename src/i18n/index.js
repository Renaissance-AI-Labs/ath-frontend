...
const languagePacks = {
  'zh-cn': {
    ...
    'crash.fairness.step1Desc': '前往“我的投注”或“全网投注”列表，找到您想要验证的那一局游戏，记录下“投注区块号”。您也可以前往钱包查找该笔交易记录，跳转至区块链浏览器 (BscScan)，在交易详情中查看 Block Number (区块号)，以确保数据真实性。',
    ...
    'crash.fairness.tp_step2Desc': '点击下方按钮打开 <b>第三方 Keccak256 计算器</b>。粘贴第一步复制的数据，<span class="text-highlight-gold">务必将 "Input Type" (输入类型) 改为 "Hex"</span>，计算并复制 <b>Output</b> 框中的哈希值 (Hash)。',
    'crash.fairness.toolLinkText': '在线 Keccak256 计算器',
    'crash.fairness.tp_step3Title': '第三步：验证 16进制转10进制 (Hex to Decimal)',
