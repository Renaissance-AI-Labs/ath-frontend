...
const languagePacks = {
  'zh-cn': {
    ...
    'toast.stakeAndBindFirst': '请先进行质押并绑定您的推荐好友',
  ...
  'zh-tw': {
    ...
    'testimonial.futureJourney': '未來的旅途 讓我們一同探索',
  ...
  'en': {
    ...
    'testimonial.yourselfShapesFuture': 'Yourself shapes the future.',
    'testimonial.futureJourney': '未来的旅途 让我们一同探索',
    ...
    'testimonial.yourselfShapesFuture': 'Yourself shapes the future.',
    'testimonial.futureJourney': 'The Journey of the Future Let\'s Explore Together',
    ...
    'toast.copySuccess': 'Copy successful! Link copied to clipboard',
  ...
  'ja': {
    ...
    'testimonial.yourselfShapesFuture': 'Yourself shapes the future.',
    'testimonial.futureJourney': '未来への旅路 共に探索しましょう',
    'testimonial.genesis': '創世',
    'testimonial.genesisEn': 'Genesis',
    ...
    'toast.stakeAndBindFirst': 'まずステーキングして紹介者をバインドしてください',
    ...
    'toast.claimSuccess': '報酬の受け取りに成功しました！',
    'toast.claimFailed': '受け取り失敗: {reason}',
  ...
  'ko': {
    ...
    'testimonial.yourselfShapesFuture': 'Yourself shapes the future.',
    'testimonial.futureJourney': '미래의 여정 함께 탐험하세요',
    ...
    'toast.copySuccess': '복사 성공! 링크가 클립보드에 복사되었습니다',
    ...
    'toast.claimFailed': '청구 실패: {reason}',
