...
const languagePacks = {
  'zh-cn': {
    ...
    'toast.investmentSubmitted': '投资已提交，请稍后在X Staking中查看',
  ...
  'zh-tw': {
    ...
    'toast.investmentSubmitted': '投資が送信されました、後ほどX Stakingで確認してください',
  ...
  'ko': {
    ...
    'toast.investmentSubmitted': '투자가 제출되었습니다. 나중에 X Staking에서 확인하십시오',
