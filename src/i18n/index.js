...
const languagePacks = {
  'zh-cn': {
    ...
    'crash.fairness.dataCompositionDesc': '用于验证的输入数据是由以下三个部分依次拼接而成的：',
    'crash.fairness.copyInput': '第一步：复制输入数据 (Hex)',
    ...
    'crash.fairness.openTool': '第二步：打开工具',
    'crash.fairness.toolLinkText': '在线 Keccak256 计算器',
    'crash.fairness.verifyInst': '第三步：粘贴数据，选择 "Hex" 输入类型，比对结果。',
  ...
  'en': {
    ...
    'crash.fairness.dataCompositionDesc': 'The input data is constructed by concatenating these three parts in order:',
    'crash.fairness.copyInput': 'Step 1: Copy Input Data (Hex)',
    ...
    'crash.fairness.openTool': 'Step 2: Open Tool',
    'crash.fairness.toolLinkText': 'Online Keccak256 Calculator',
    'crash.fairness.verifyInst': 'Step 3: Paste data, select "Hex" input type, and compare.',
